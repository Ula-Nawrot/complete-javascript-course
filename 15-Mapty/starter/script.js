...
class Workout {
    //class field
    date = new Date();
    id = (Date.now() + '').slice(-10); //usually better to use 3part library
...
// const run1 = new Running([38, -12], 5.2, 23, 179);
// const cycling1 = new Cycling([38, -12], 5.2, 23, 179);
...
class App {
    ...
    _loadMap(position) {
        ...
        this.#map = L.map('mapid').setView([latitude, longitude], 13);
    ...
    _newWorkOut(e) {
        ...
        const distance = +inputDistance.value; //changing into a number
        ...
        this.#workouts.push(workout); //adding to an array
        console.log(workout);
